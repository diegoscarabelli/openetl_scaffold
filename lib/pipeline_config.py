...
__post_init__ derives db_schema and data_dirs from pipeline_id, so most
pipelines only need to set a handful of fields explicitly.
"""
...
class PipelineConfig:
    ...
    db_schema: str = ""
    """PostgreSQL schema — defaults to pipeline_id. Set in __post_init__."""

    data_dirs: ETLDataDirectories = field(default_factory=ETLDataDirectories)
    """Resolved data directory paths. Auto-populated in __post_init__."""
